<!doctype html>
<html class="no-js" lang="en" ng-app="myapp" ng-controller="userscontroller">
<head>
    <meta charset="utf-8">
                        ...
                        <div class="table-responsive">
                            <table class="table table-border text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr dir-paginate="th in userss|filter: timkiem |itemsPerPage:itemPerPage">
                                        <td>@{{$index+serial}}</td>
                                        <td>@{{th.nhvien.ten_nv}}</td>
                                        <td>@{{th.user_name}}</td>
                                        <td>@{{th.password}}</td>
                                        <td><img src="/image/users/@{{th.anh}}" style='width:100%' alt=""></td>
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <div ng-model="product" >
                                        <label  class="col-lg-4 col-md-6 col-sm-6" style="float:left;padding-left:0px">Nhân viên</label>
                                        <select style="width:40%;" ng-model='ma_nv' class="form-control form-control-lg col-lg-8 col-md-6 col-sm-6" >
                                ...
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="users.user_name">
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                ...
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file mb-3">
                                            <input type="file" class="custom-file-input" id="customFile" name="filename" ng-model="users.anh">
                                            <label class="custom-file-label" class="form-control" id='img' for="customFile" >@{{users.anh}}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
