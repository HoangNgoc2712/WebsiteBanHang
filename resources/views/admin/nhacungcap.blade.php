<!doctype html>
<html class="no-js" lang="en" ng-app="myapp" ng-controller="nhacungcapcontroller">
<head>
    <meta charset="utf-8">
                        ...
                        <div class="table-responsive">
                            <table class="table table-border text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr  dir-paginate="ncc in nhacc|filter: timkiem |itemsPerPage:itemPerPage">
                                        <td>@{{$index+serial}}</td>
                                        <td>@{{ncc.ten_ncc}}</td>
                                        <td >@{{ncc.dia_chi}}</td>
                                        <td>@{{ncc.email}}</td>
                                        <td >@{{ncc.sdt}}</td>
                                        <td><button class="btn btn-info fa fa-pen" style="height:30px; width:30px;" ng-click="showmodal(ncc.id)">&nbsp;</button></td>
                                        <td><button class="btn btn-danger fa fa-trash" style="height:30px; width:30px" ng-click="deleteClick(ncc.id)">&nbsp;</button></td>
                            ...
                            <div class="modal-header">
                                    <h5 class="modal-title">@{{modalTitle}}</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <nccan aria-hidden="true">&times;</nccan>
                                        </button>
                                </div>
                        <div class="modal-body">
                            <div class="container-fluid">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" ng-model="nhaccs.ten_ncc">
                                    </div>
                                </div>
                            </div>
                            <div class="container-fluid">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" ng-model="nhaccs.dia_chi">
                                    </div>
                                </div>
                            </div>
                            <div class="container-fluid">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" ng-model="nhaccs.email">
                                    </div>
                                </div>
                            </div>
                            <div class="container-fluid">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" ng-model="nhaccs.sdt">
                                    </div>
                                </div>
                            </div>
