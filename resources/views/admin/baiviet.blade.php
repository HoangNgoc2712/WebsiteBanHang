<!doctype html>
<html class="no-js" lang="en" ng-app="myapp" ng-controller="blogcontroller">
<head>
    <meta charset="utf-8">
                        ...
                        <div class="table-responsive">
                            <table class="table table-border text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr dir-paginate="th in blogs|filter: timkiem |itemsPerPage:itemPerPage">
                                        <td>@{{$index+serial}}</td>
                                        <td>@{{th.tieu_de}}</td>
                                        <td style="width: 500px; overflow: hidden;text-overflow: ellipsis;line-height: 25px;
                                            -webkit-line-clamp: 3;height: 75px;display: -webkit-box;-webkit-box-orient: vertical;">
                                            @{{th.noi_dung}}</td>
                                        <td><img src="/image/blog/@{{th.anh}}" style='width:100%' alt=""></td>
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="blog.tieu_de">
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <textarea style="height: 300px" type="text" class="form-control" ng-model="blog.noi_dung">@{{blog.noi_dung}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file mb-3">
                                            <input type="file" class="custom-file-input" id="customFile" name="filename" ng-model="blog.anh">
                                            <label class="custom-file-label" class="form-control" id='img' for="customFile" >@{{blog.anh}}</label>
                                        </div>
                                    </div>
                                </div>
