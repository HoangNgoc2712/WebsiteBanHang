                            ...
                            <table class="table table-border text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr dir-paginate="th in hdbans|filter: timkiem |itemsPerPage:itemPerPage">
                                        <td>@{{$index+serial}}</td>
                                        <!-- <td ng-click="Billsdetail(th.id)">@{{th.khach.ten_kh}}</td> -->
                                        <td ng-click="Billsdetail(th.id)">@{{th.ten_nguoinhan}}</td>
                                        <td>@{{th.sdt_nhan}}</td>
                                        <td>@{{th.diachi_nhan}}</td>
                                        <td>@{{th.ngay_ban}}</td>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="container-fluid">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" ng-model="hdban.diachi_nhan">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="container-fluid">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" placeholder="yyyy/mm/dd" class="form-control" ng-model="hdban.ngay_ban" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="container-fluid">
                                    ...
                                    <div class="container-fluid">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" ng-model="hdban.hinh_thuc_thanh_toan">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <tbody>
                                            <tr ng-repeat="ct in CTHDBan">
                                                ...
                                                <td class="a-right" style="margin-top: 20px;">
                                                    ...
                                                    <span class="price" style="font-family: 'Lato', Sans-Serif;font-size:13px; color: black">@{{ct.don_gia |number:0}} đ</span>
                                                    </span>
                                                </td>
                                                ...
                                                <td class="a-right" style="margin-top: 20px;">
                                                    ...
                                                    <span class="price"  style="font-family: 'Lato', Sans-Serif;font-size:13px; color: black">@{{ct.so_luong * ct.don_gia | number : 0}} đ</span>
                                                    </span>
                                                </td>
