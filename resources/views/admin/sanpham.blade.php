                            ...
                            <div class="modal-body">   
                                <div class="col-lg-6 col-md-6 col-sm-12" style="float:left; width:80%">
                                    ...
                                    <div class="container-fluid" class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <div ng-model="product"  > 
                                                <label  class="col-lg-12 col-md-12 col-sm-12" style="padding-left:0px">Dòng sản phẩm </label>
                                                <br/>
                                    ...
                                    <div class="container-fluid" class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <div ng-model="product" >
                                                <label  class="col-lg-12 col-md-12 col-sm-12" style="padding-left:0px">Nhà cung cấp</label>
                                ...
                                <div  class="col-lg-6 col-md-6 col-sm-12" >
                                    ...
                                    <div class="container-fluid">
                                        <div class="form-group">
                                            <label for="name">Ảnh Nhỏ 1</label>
                                            <!-- <form>
                                                <input type="file" id='img' onchange="preview()" ng-model="product.anh">
                                                <img id="thumb" src=""  width="150px"/>
                                            </form> -->
                                    ...
                                    <div class="container-fluid">
                                        <div class="form-group">
                                            <label for="name">Ảnh Nhỏ 2</label>
                                            <!-- <form>
                                                <input type="file" id='img' onchange="preview()" ng-model="product.anh">
                                                <img id="thumb" src=""  width="150px"/>
                                            </form> -->
...
<!-- Modal xem đầy đủ thông tin sản phẩm -->
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="col-lg-6 col-md-6 col-sm-12" style="float:left; width:80%">
                                ...
                                <div class="container-fluid">
                                    <div class="form-group">
                                        <label class="col-lg-4 col-md-6 col-sm-6" style="float:left;padding-left:0px" for="name">Ảnh</label>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12" >
                                ...
                                <div class="container-fluid">
                                    <div class="form-group">
                                        <label class="col-lg-4 col-md-6 col-sm-6" style="float:left;padding-left:0px" for="name">Ảnh nhỏ 1</label>
                                        <form class="col-lg-8 col-md-6 col-sm-6">
                                ...
                                <div class="container-fluid">
                                    <div class="form-group">
                                        <label class="col-lg-4 col-md-6 col-sm-6" style="float:left;padding-left:0px" for="name">Ảnh nhỏ 2</label>
                                        <form class="col-lg-8 col-md-6 col-sm-6">
