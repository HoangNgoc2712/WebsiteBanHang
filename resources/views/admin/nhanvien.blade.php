                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-border text-nowrap">
                                ...
                                <tbody>
                                    <tr dir-paginate="sp in employees|filter: timkiem |itemsPerPage:itemPerPage">
                                        <td>@{{$index + serial}}</td>
                                        <td>@{{sp.ten_nv}}</td>
                                        <td>@{{sp.gioi_tinh}}</td>
                                        <td>@{{sp.ngay_sinh}}</td>
                                        <td>@{{sp.que_quan}}</td>
                                        <td align="right">@{{sp.sdt}}</td>
                                        <td>@{{sp.email}}</td>
                                        <td>@{{sp.chuc_vu}}</td>                             
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    ...
                                    <label for="name">Ten nhan vien:</label>
                                        <div>
                                            <input type="text" class="form-control" ng-model="employee.ten_nv">
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="employee.gioi_tinh">
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="employee.ngay_sinh" placeholder="yyyy-mm-dd">
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="employee.que_quan">
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="employee.sdt">
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                ...
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="employee.chuc_vu">
                                        </div>
                                    </div>
                                </div>
