                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="container-fluid" class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <div ng-model="hdnhap"  > 
                                            <label  class="col-lg-4 col-md-6 col-sm-6" style="float:left;padding-left:0px">Hóa đơn nhập</label>
                                ...
                                <div class="container-fluid" class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <div ng-model="hdnhap" >
                                            <label  class="col-lg-4 col-md-6 col-sm-6" style="float:left;padding-left:0px">Sản phẩm</label>
