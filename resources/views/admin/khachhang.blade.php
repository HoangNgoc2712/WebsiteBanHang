<!doctype html>
<html class="no-js" lang="en" ng-app="myapp" ng-controller="khachhangcontroller">
<head>
    <meta charset="utf-8">
                        ...
                        <div class="table-responsive">
                            <table class="table table-border text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr  dir-paginate="kh in customer|filter: timkiem |itemsPerPage:itemPerPage">
                                        <td>@{{$index+serial}}</td>
                                        <td>@{{kh.ten_kh}}</td>
                                        <td>@{{kh.email}}</td>
                                        <td >@{{kh.dia_chi}}</td>
                                        ...
                                        <td >@{{kh.users_name}}</td>
                                        <td >@{{kh.password}}</td>
                                        <td><button class="btn btn-info fa fa-pen" style="height:30px; width:30px;" ng-click="showmodal(kh.id)">&nbsp;</button></td>
                                        <td><button class="btn btn-danger fa fa-trash" style="height:30px; width:30px" ng-click="deleteClick(kh.id)">&nbsp;</button></td>
                                ...
                                <div class="modal-header">
                                        <h5 class="modal-title">@{{modalTitle}}</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <khan aria-hidden="true">&times;</khan>
                                            </button>
                                    </div>
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="khach.ten_kh">
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                ...
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="khach.email">
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="khach.sdt">
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="khach.users_name">
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="khach.password">
                                        </div>
                                    </div>
                                </div>
