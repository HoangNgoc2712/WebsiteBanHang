<!doctype html>
<html class="no-js" lang="en" ng-app="myapp" ng-controller="dongsanphamcontroller">
<head>
    <meta charset="utf-8">
...
<body>
                        ...
                        <div class="table-responsive">
                            <table class="table table-border text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr dir-paginate="dsp in dongsanphams|filter: timkiem |itemsPerPage:itemPerPage">
                                        <td>@{{$index+serial}}</td>
                                        <td>@{{dsp.ten_dong}}</td>
                                        <td>@{{dsp.thhieu.ten_thuong_hieu}}</td>
                                        <td><button class="btn btn-info fa fa-pen" style="height:30px; width:30px;" ng-click="showmodal(dsp.id)">&nbsp;</button></td>
                                        <td><button class="btn btn-danger fa fa-trash" style="height:30px; width:30px" ng-click="deleteClick(dsp.id)">&nbsp;</button></td>
                                ...
                                <div class="modal-header">
                                        <h5 class="modal-title">@{{modalTitle}}</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <dspan aria-hidden="true">&times;</dspan>
                                            </button>
                                    </div>
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="dongsp.ten_dong">
                                        </div>
                                    </div>
                                </div>
                                <div class="container-fluid" class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <div ng-model="dongsp" >
                                            <label  class="col-lg-4 col-md-6 col-sm-6" style="float:left;padding-left:0px">Thương hiệu</label>
                                            <select style="width:40%;" ng-model='dongsp.ma_thuong_hieu' class="form-control form-control-lg col-lg-8 col-md-6 col-sm-6" >
                                                <option value="" selected>Chọn</option>
                                                <option ng-repeat="lsp in thuonghieus" value="@{{lsp.id}}">@{{lsp.ten_thuong_hieu}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="/JS/dongsanphamcontroller.js"> </script> 
</body>
</html>