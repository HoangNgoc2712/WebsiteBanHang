            ...
            <div class="col-main  col-lg-12 col-md-12 col-xs-12">
              ...
              <div class="top-toolbar"  >
                ...
                <div class="toolbar">
                  ...
                  <!--sorter-->
                  <!-- <div id="sort-by" class="col-3-xxxl col-xl-3 col-lg-4 col-12 form-group" >
                    <ul>
                  ...
                  <div class="pager">
                    ...
                    <div id="limiter" class="col-3-xxxl col-xl-3 col-lg-4 col-12 form-group" style=" width: 50%; float: right">
                          ...
                          <input type="number" style="width: 55px;height:35px " min="1" max="100" class="form-control" ng-model="itemPerPage2">
              ...
              <!-- BEGIN CATEGORY PRODUCTS -->
                <div class="category-products " >
                    <ul class="products-grid"  dir-paginate="sp in products|filter: timkiem |itemsPerPage:itemPerPage2">
