<!doctype html>
<html class="no-js" lang="en" ng-app="myapp" ng-controller="thuonghieucontroller">
<head>
    <meta charset="utf-8">
...
<body>
                        ...
                        <div class="table-responsive">
                            <table class="table table-border text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr dir-paginate="th in thuonghieus|filter: timkiem |itemsPerPage:itemPerPage">
                                        <td>@{{$index+serial}}</td>
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" ng-model="thuonghieu.ten_thuong_hieu">
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="/JS/thuonghieucontroller.js"> </script> 
</body>
</html>